...
(function () {
  ...
  const i18n = {
    ar: {
      ...
      bndl1: 'قنينة واحدة',
      bndl1_desc: 'للتجربة • كفاية شهر',
      bndl2: 'باك قنينتين',
      bndl2_desc: 'أكثر عرض مطلوب • كفاية شهرين',
      bndl3: 'باك 3 قنينات',
      bndl3_desc: 'أفضل قيمة لكورس 3 شهور للشعر',
    ...
    fr: {
      ...
      bndl1: 'Flacon unique',
      bndl1_desc: 'Pour essayer • 1 mois',
      bndl2: 'Pack 2 flacons',
      bndl2_desc: 'Notre pack le plus demandé • 2 mois',
  ...
  // Bundle data
  const bundles = {
    b1: { id: 'b1', name_ar: 'قنينة واحدة', name_fr: 'Flacon unique', price: 199 },
    b2: { id: 'b2', name_ar: 'باك قنينتين', name_fr: 'Pack 2 flacons', price: 229 },
    b3: { id: 'b3', name_ar: 'باك 3 قنينات', name_fr: 'Pack 3 flacons', price: 249 }
  };
